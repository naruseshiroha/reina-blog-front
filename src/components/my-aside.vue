<template>
  <div class="aside">
    <!-- search -->
    <n-input-group>
      <n-input maxlength="20" placeholder="请输入关键字进行搜索" show-count clearable />
      ...
      >
        ...
        <n-form-item label="验证码" path="verifyCode">
          <n-input
            ...
            clearable
          />
          <n-button :disabled="loadingCode" type="tertiary" @click="getVerifyCode"
...
const getVerifyCode = async (email: string): Promise<string> => {
  // validate form
  let limit = 60;
